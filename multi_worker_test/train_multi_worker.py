...
from misc.tf_utils import check_tf_version, allow_memory_growth
from datasets.imagenet import get_dataset, augmentation_v1, augmentation_v2

from moco_multi_worker import MoCo


def main():
    # check tensorflow version
    cur_tf_ver = check_tf_version(tf_min_ver='2.3.0')
    ...
    global_batch_size = args['batch_size_per_replica'] * num_workers
